...
# 卷积层的输入对应卷积核的通道，输出对应卷积核的个数，卷积层的weight参数为 f,c,w,h f为卷积核个数，c为卷积核的通道
# 钩子总是注册在当前卷积层后下一卷积层的前一层，从当前特征图决定args.exp_name值
# 最终删减的目标是卷积层的输出通道，连带网络其他参数，但只是加载权重，其他的重新训练
